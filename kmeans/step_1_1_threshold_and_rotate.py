...
contours, _ = cv2.findContours(th3, cv2.RETR_LIST, cv2.CHAIN_APPROX_NONE)
...
#Extract objects based on the area of interest:
...
for i,c in enumerate(contours):
  ...
  cv2.drawContours(imgCol, contours, i, (0, 0, 255), 2)
  # find orientation of each shape
  get_orientation(c,imgCol)
